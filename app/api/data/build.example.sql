...
CREATE TABLE `dbl_admin_log` (
  ...
  `details` text NOT NULL COMMENT '备注',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8mb4 COMMENT='后台操作日志表';
...
INSERT INTO `dbl_admin_log` VALUES (104, '没有记录菜单的操作', 1, 'UPDATE `dbl_admin_config`  SET `id` = 9 , `group` = \'develop\' , `field` = \'develop_mode\' , `title` = \'开发模式\' , `template` = \'radio\' , `value` = \'1\' , `options` = \'1:开启\r\n0:关闭\' , `sort` = 50 , `update_time` = 1572770680  WHERE  `id` = 9', '', '/admin.php/admin/config/edit.html', '0', '1', 1572770681, 1572770681);
INSERT INTO `dbl_admin_log` VALUES (105, '没有记录菜单的操作', 1, 'UPDATE `dbl_admin_config`  SET `id` = 9 , `group` = \'develop\' , `field` = \'develop_mode\' , `title` = \'开发模式\' , `template` = \'radio\' , `value` = \'1\' , `options` = \'1:开启\r\n0:关闭\' , `sort` = 50 , `update_time` = 1572770731  WHERE  `id` = 9', '', '/admin.php/admin/config/edit.html', '0', '1', 1572770731, 1572770731);
INSERT INTO `dbl_admin_log` VALUES (106, '没有记录菜单的操作', 1, 'UPDATE `dbl_admin_config`  SET `id` = 9 , `group` = \'develop\' , `field` = \'develop_mode\' , `title` = \'开发模式\' , `template` = \'radio\' , `value` = \'1\' , `options` = \'1:开启\r\n0:关闭\' , `sort` = 50 , `update_time` = 1572770737  WHERE  `id` = 9', '', '/admin.php/admin/config/edit.html', '0', '1', 1572770737, 1572770737);
INSERT INTO `dbl_admin_log` VALUES (107, '没有记录菜单的操作', 1, 'UPDATE `dbl_admin_config`  SET `id` = 9 , `group` = \'develop\' , `field` = \'develop_mode\' , `title` = \'开发模式\' , `template` = \'radio\' , `value` = \'1\' , `options` = \'1:开启\r\n0:关闭\' , `sort` = 50 , `update_time` = 1572770830  WHERE  `id` = 9', '', '/admin.php/admin/config/edit.html', '0', '1', 1572770830, 1572770830);
INSERT INTO `dbl_admin_log` VALUES (108, '没有记录菜单的操作', 1, 'UPDATE `dbl_admin_config`  SET `id` = 9 , `group` = \'develop\' , `field` = \'develop_mode\' , `title` = \'开发模式\' , `template` = \'radio\' , `value` = \'1\' , `options` = \'1:开启\r\n0:关闭\' , `sort` = 50 , `update_time` = 1572770852  WHERE  `id` = 9', '', '/admin.php/admin/config/edit.html', '0', '1', 1572770852, 1572770852);
INSERT INTO `dbl_admin_log` VALUES (109, '没有记录菜单的操作', 1, 'UPDATE `dbl_admin_menu`  SET `id` = 23 , `app` = \'api\' , `pid` = 22 , `title` = \'应用接入\' , `url_value` = \'\' , `icon` = \'dui-icon-apps\' , `sort` = 100 , `state` = 1 , `update_time` = 1572770933  WHERE  `id` = 23', '', '/admin.php/admin/menu/edit.html', '0', '1', 1572770933, 1572770933);
INSERT INTO `dbl_admin_log` VALUES (110, '删除接口', 1, 'DELETE FROM `dbl_api_list` WHERE  `id` = 2', '', '/admin.php/api/index/delete.html', '0', '0', 1572773105, 1572773105);
INSERT INTO `dbl_admin_log` VALUES (111, '没有记录菜单的操作', 1, 'INSERT INTO `dbl_api_app` SET `id` = 0 , `name` = \'开发者部落pc端\' , `app_group` = \'5db55dcccdd66\' , `app_id` = \'17897258\' , `app_secret` = \'d2c75f7a5289907e85ce9a2b0dccedf0\' , `description` = \'\' , `app_api` = \'[\\\"5db5c20c9abaa\\\",\\\"5dbe9fafa8b2f\\\"]\' , `state` = 1 , `create_time` = 1572790342 , `update_time` = 1572790342', '', '/admin.php/api/app/add.html', '0', '1', 1572790342, 1572790342);
INSERT INTO `dbl_admin_log` VALUES (112, '没有记录菜单的操作', 1, 'INSERT INTO `dbl_api_app` SET `id` = 0 , `name` = \'asdasdasd\' , `app_group` = \'5db55dcccdd66\' , `app_id` = \'87912998\' , `app_secret` = \'6f2071336da4a0e36b0c16bb31eaafcc\' , `description` = \'\' , `app_api` = \'[\\\"5db5c20c9abaa\\\",\\\"5dbe9fafa8b2f\\\"]\' , `state` = 1 , `create_time` = 1572791305 , `update_time` = 1572791305', '', '/admin.php/api/app/add.html', '0', '1', 1572791305, 1572791305);
INSERT INTO `dbl_admin_log` VALUES (113, '没有记录菜单的操作', 1, 'INSERT INTO `dbl_api_app` SET `id` = 0 , `name` = \'asdasdasd\' , `app_group` = \'5db55dcccdd66\' , `app_id` = \'87913306\' , `app_secret` = \'fd4a6edb7599c7fb09dd0404d3078916\' , `description` = \'asdasd\' , `app_api` = \'[\\\"5db5c20c9abaa\\\",\\\"5dbe9fafa8b2f\\\"]\' , `state` = 1 , `create_time` = 1572791334 , `update_time` = 1572791334', '', '/admin.php/api/app/add.html', '0', '1', 1572791334, 1572791334);
INSERT INTO `dbl_admin_log` VALUES (114, '没有记录菜单的操作', 1, 'INSERT INTO `dbl_api_app` SET `id` = 0 , `name` = \'asdasdasd\' , `app_group` = \'5db55dcccdd66\' , `app_id` = \'87913306\' , `app_secret` = \'fd4a6edb7599c7fb09dd0404d3078916\' , `description` = \'asdasd\' , `app_api` = \'[\\\"5db5c20c9abaa\\\",\\\"5dbe9fafa8b2f\\\"]\' , `state` = 1 , `create_time` = 1572791340 , `update_time` = 1572791340', '', '/admin.php/api/app/add.html', '0', '1', 1572791340, 1572791340);
INSERT INTO `dbl_admin_log` VALUES (115, '没有记录菜单的操作', 1, 'INSERT INTO `dbl_api_app` SET `id` = 0 , `name` = \'asdasdasd\' , `app_group` = \'5db55dcccdd66\' , `app_id` = \'87913306\' , `app_secret` = \'fd4a6edb7599c7fb09dd0404d3078916\' , `description` = \'asdasd\' , `app_api` = \'[\\\"5db5c20c9abaa\\\",\\\"5dbe9fafa8b2f\\\"]\' , `state` = 1 , `create_time` = 1572791347 , `update_time` = 1572791347', '', '/admin.php/api/app/add.html', '0', '1', 1572791347, 1572791347);
COMMIT;
...
INSERT INTO `dbl_admin_menu` VALUES (23, 22, 'api', '应用接入', 'dui-icon-apps', '', '_pjax', '', 0, 1546252114, 1572770933, 100, 1, '1');
...
CREATE TABLE `dbl_api_app` (
  ...
  `app_group` varchar(20) NOT NULL COMMENT '分组hash',
  `app_id` varchar(10) NOT NULL COMMENT '应用唯一识别号',
  `app_secret` varchar(32) NOT NULL COMMENT '应用密码',
  `app_api` text COMMENT '包含的api接口',
  `description` varchar(150) NOT NULL COMMENT '分组说明',
...
-- ----------------------------
BEGIN;
INSERT INTO `dbl_api_app` VALUES (1, '开发者部落PC端', '5db55dcccdd66', '57895906', '2fac640c44752baa4e1a397be8739d0e', '[\"5db5c20c9abaa\",\"5dbe9fafa8b2f\"]', '这里集结的是开发者部落pc端的接口', '1', 1572789622, 1572789622);
COMMIT;
...
CREATE TABLE `dbl_api_list` (
  ...
  `access_token` enum('0','1','2') NOT NULL DEFAULT '1' COMMENT '0为不认证，1为简单验证，1为复杂验证',
...
-- ----------------------------
BEGIN;
INSERT INTO `dbl_api_list` VALUES (1, '获取access-token', '5db5c20c9abaa', '1', 'BuildToken/getAccessToken', '0', '0', NULL, 'form', 'application/json', '[{\"name\":\"app_id\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"服务器颁发的应用ID\",\"example\":\"57895903\",\"options\":\"\"},{\"name\":\"app_secret\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"服务器颁发的应用秘钥\",\"example\":\"2fac640c44752baa4e1a3dase8739d0e\",\"options\":\"\"},{\"name\":\"device_id\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"设备唯一ID\",\"example\":\"\",\"options\":\"\"},{\"name\":\"rand_str\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"随机字符串\",\"example\":\"agsdfesdfasdgsdfesdfa\",\"options\":\"\"},{\"name\":\"timestamp\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"系统当前时间戳10位\",\"example\":\"1572789622\",\"options\":\"\"},{\"name\":\"signature\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"生成后的验证字符串\",\"example\":\"2fac640c44752sda4e1a3dase8739d0e\",\"options\":\"\"}]', '[{\"name\":\"code\",\"type\":\"2\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"1\",\"options\":\"\"},{\"name\":\"msg\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"操作成功\",\"options\":\"\"},{\"name\":\"data\",\"type\":\"8\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"\",\"options\":\"\"},{\"name\":\"data{}access_token\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"611683ab0392479e05b56e2182bcd608\",\"options\":\"\"},{\"name\":\"data{}expires_in\",\"type\":\"2\",\"require\":true,\"default\":\"\",\"remark\":\"acces-token的有效期\",\"example\":\"7200\",\"options\":\"\"}]', '{\r\n    \"code\": 1, \r\n    \"msg\": \"操作成功\", \r\n    \"data\": {\r\n        \"access_token\": \"611683ab0392479e05b56e2182bcd608\", \r\n        \"expires_in\": 7200\r\n    }\r\n}', '{\r\n    \"code\": -26,\r\n    \"msg\": \"签名验证失败，请重新核对!\"\r\n}', NULL, '5db5c9f554463', '1', 1572192876, 1572794935);
INSERT INTO `dbl_api_list` VALUES (2, '用户登录', '5dbe9fafa8b2f', '1', 'member/Publics/login', '2', '0', NULL, 'form', 'application/json', '[{\"name\":\"username\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"用户名|手机号|邮箱\",\"example\":\"admin\",\"options\":\"\"},{\"name\":\"password\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"密码\",\"example\":\"123456\",\"options\":\"\"}]', '[{\"name\":\"code\",\"type\":\"2\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"1\",\"options\":\"\"},{\"name\":\"msg\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"登录成功！\",\"options\":\"\"},{\"name\":\"data\",\"type\":\"8\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"\",\"options\":\"\"},{\"name\":\"data{}user-token\",\"type\":\"1\",\"require\":true,\"default\":\"\",\"remark\":\"\",\"example\":\"61a6fec8aaf8e3fd6ba0d101efddf9f5\",\"options\":\"\"},{\"name\":\"data{}expires\",\"type\":\"2\",\"require\":true,\"default\":\"\",\"remark\":\"token的有效时间\",\"example\":\"7200\",\"options\":\"\"}]', '{\r\n    \"code\": 1, \r\n    \"msg\": \"登录成功！\", \r\n    \"data\": {\r\n        \"user-token\": \"61a6fec8aaf8e3fd6ba0d101efddf9f5\", \r\n        \"expires\": 7200\r\n    }\r\n}', '{\r\n    \"code\": -1, \r\n    \"msg\": \"用户名或者密码错误！\"\r\n}', NULL, '5db5c9f554463', '3', 1572773885, 1572794968);
COMMIT;
