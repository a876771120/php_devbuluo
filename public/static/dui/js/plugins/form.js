(function (global, factory) {
    ...
    var form = function form(el, type, option) {
      ...
      }(), '<span class="dui-switch__core" style="width: ' + config.width + 'px;"></span>', function () {
      ...
      hasRender.parents('.' + ClassName.checkbox).after(el) && // 移除显示元素
      hasRender.parents('.' + ClassName.checkbox).remove(); // 插入显示元素
